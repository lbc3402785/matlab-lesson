function [inter1,inter2,num]=computeIntersectionOfTwoDiscSector(normal,u1,radian1,u2,radian2)
    ...
    elseif (radian1<pi*0.5&&radian2>=0.5*pi)
        ...
        elseif (t0.isIntersecting&&t3.isIntersecting&&t0.a1>=t3.a0)
            t0.a1=t3.a1;
            t3.isIntersecting=false;
        elseif (t1.isIntersecting&&t2.isIntersecting&&t1.a1>=t2.a0)
            t1.a1=t2.a1;
            t2.isIntersecting=false;
        elseif (t1.isIntersecting&&t3.isIntersecting&&t1.a1>=t3.a0)
            t1.a1=t3.a1;
            t3.isIntersecting=false;
        end
        %到这里合并到最多只剩两个
