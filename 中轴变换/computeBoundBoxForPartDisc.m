...
minY=center(2);
maxY=center(2);
y1=center(2)+radius*cosRadian*u(2)+radius*sinRadian*v(2);
y2=center(2)+radius*cosRadian*u(2)-radius*sinRadian*v(2);
if (costheta>0&&costheta>cosRadian)%case1 case2
...
minZ=center(3);
maxZ=center(3);
z1=center(3)+radius*cosRadian*u(3)+radius*sinRadian*v(3);
z2=center(3)+radius*cosRadian*u(3)-radius*sinRadian*v(3);
if (costheta>0&&costheta>cosRadian)%case1 case2
